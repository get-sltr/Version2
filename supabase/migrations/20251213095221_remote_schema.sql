...
CREATE TABLE IF NOT EXISTS "public"."cruising_updates" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid",
    "text" "text",
...
ALTER TABLE "public"."cruising_updates" OWNER TO "postgres";
...
ALTER TABLE "public"."profile_albums" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."profiles" (
    ...
    "meet_at" "text"[] DEFAULT '{}'::"text"[],
    "accepts_nsfw" boolean DEFAULT false,
    "gender" "text",
    "pronouns" "text",
    "hiv_status" "text",
    "last_tested" "date",
    ...
    "show_tribes" boolean DEFAULT true,
...
ALTER TABLE "public"."saved_phrases" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."taps" (
    ...
    "sender_id" "uuid",
    "recipient_id" "uuid",
    "type" "text" DEFAULT 'tap'::"text",
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."taps" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."blocks"
    ADD CONSTRAINT "blocks_user_id_blocked_user_id_key" UNIQUE ("user_id", "blocked_user_id");



ALTER TABLE ONLY "public"."cruising_updates"
    ADD CONSTRAINT "cruising_updates_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."profile_albums"
    ADD CONSTRAINT "profile_albums_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."saved_phrases"
    ADD CONSTRAINT "saved_phrases_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."taps"
    ADD CONSTRAINT "taps_sender_id_recipient_id_key" UNIQUE ("sender_id", "recipient_id");
...
CREATE INDEX "idx_profiles_online" ON "public"."profiles" USING "btree" ("is_online", "last_seen");



CREATE INDEX "idx_taps_recipient" ON "public"."taps" USING "btree" ("recipient_id", "created_at" DESC);



CREATE OR REPLACE TRIGGER "profiles_updated" BEFORE UPDATE ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."update_timestamp"();
...
ALTER TABLE ONLY "public"."blocks"
    ADD CONSTRAINT "blocks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."cruising_updates"
    ADD CONSTRAINT "cruising_updates_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."photos"
    ADD CONSTRAINT "photos_album_fk" FOREIGN KEY ("album_id") REFERENCES "public"."albums"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."profile_albums"
    ADD CONSTRAINT "profile_albums_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."profile_photos"
    ADD CONSTRAINT "profile_photos_album_id_fkey" FOREIGN KEY ("album_id") REFERENCES "public"."profile_albums"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."saved_phrases"
    ADD CONSTRAINT "saved_phrases_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."taps"
    ADD CONSTRAINT "taps_recipient_id_fkey" FOREIGN KEY ("recipient_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."taps"
    ADD CONSTRAINT "taps_sender_id_fkey" FOREIGN KEY ("sender_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "Users can manage own albums" ON "public"."profile_albums" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage own blocks" ON "public"."blocks" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage own photos" ON "public"."photos" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage own photos" ON "public"."profile_photos" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can send taps" ON "public"."taps" FOR INSERT WITH CHECK (("auth"."uid"() = "sender_id"));
...
CREATE POLICY "Users can view received taps" ON "public"."taps" FOR SELECT USING ((("auth"."uid"() = "recipient_id") OR ("auth"."uid"() = "sender_id")));
...
GRANT ALL ON TABLE "public"."cruising_updates" TO "anon";
GRANT ALL ON TABLE "public"."cruising_updates" TO "authenticated";
GRANT ALL ON TABLE "public"."cruising_updates" TO "service_role";
...
GRANT ALL ON TABLE "public"."profile_albums" TO "anon";
GRANT ALL ON TABLE "public"."profile_albums" TO "authenticated";
GRANT ALL ON TABLE "public"."profile_albums" TO "service_role";
...
GRANT ALL ON TABLE "public"."saved_phrases" TO "anon";
GRANT ALL ON TABLE "public"."saved_phrases" TO "authenticated";
GRANT ALL ON TABLE "public"."saved_phrases" TO "service_role";
...
GRANT ALL ON TABLE "public"."taps" TO "anon";
GRANT ALL ON TABLE "public"."taps" TO "authenticated";
GRANT ALL ON TABLE "public"."taps" TO "service_role";
...
CREATE TRIGGER on_auth_user_created AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();
  ...
  create policy "allow all operations 1oj01fe_0"
  on "storage"."objects"
  as permissive
  for select
  to authenticated
using ((bucket_id = 'avatars'::text));
  ...
  create policy "allow all operations 1oj01fe_1"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check ((bucket_id = 'avatars'::text));
  ...
  create policy "allow all operations 1oj01fe_2"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
using ((bucket_id = 'avatars'::text));
  ...
  create policy "allow all operations 1oj01fe_3"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
...
using ((bucket_id = 'avatars'::text));
  ...
  create policy "allow delete on profile-media"
  on "storage"."objects"
  as permissive
  for delete
  to authenticated
using ((bucket_id = 'profile-media'::text));
  ...
  create policy "allow insert on profile-media"
  on "storage"."objects"
  as permissive
  for insert
  to authenticated
with check ((bucket_id = 'profile-media'::text));



  create policy "allow select on avatars"
  on "storage"."objects"
  as permissive
  for select
...
using ((bucket_id = 'avatars'::text));
  ...
  create policy "allow select on profile-media"
  on "storage"."objects"
  as permissive
  for select
  to authenticated, anon
...
using ((bucket_id = 'avatars'::text));
  ...
  create policy "allow update on profile-media"
  on "storage"."objects"
  as permissive
  for update
  to authenticated
