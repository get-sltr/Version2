...
interface DTHBadgeProps {
  isActive: boolean;
  size?: 'sm' | 'md' | 'lg';
}

export function DTHBadge({ isActive, size = 'sm' }: DTHBadgeProps) {
  ...
  return (
    <div
      style={{
        ...
        animation: 'dth-pulse-glow 2s ease-in-out infinite',
      }}
    >
      {/* Large droplet */}
      <svg
